...
- 当前仓库内直接承接材料：
  - `docs/internal/paper-reports/white-box/2024-neurips-finding-nemo-localizing-memorization-neurons-diffusion-models-report.md`
  - `workspaces/white-box/signal-access-matrix.md`
  - `docs/internal/claude-report-4-9-review.md`
