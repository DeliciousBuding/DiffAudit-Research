...
- local source:
  ...
  - `docs/internal/paper-reports/gray-box/2025-arxiv-sima-score-based-membership-inference-diffusion-models-report.md`
- strongest current repo fit:
...
- local source:
  ...
  - `docs/internal/paper-reports/gray-box/2026-openreview-mofit-caption-free-membership-inference-report.md`
- strongest current repo fit:
