...
- `docs/internal/paper-reports/README.md` and `docs/internal/paper-reports/report-spec.md` no longer require legacy `LocalOps/feishu/...` paths as if they were portable prerequisites
...
- use [docs/assets-and-storage/storage-boundary.md](../../docs/assets-and-storage/storage-boundary.md) for the canonical storage rule
- use [docs/assets-and-storage/data-and-assets-handoff.md](../../docs/assets-and-storage/data-and-assets-handoff.md) and [docs/teammate-setup.md](../../docs/teammate-setup.md) for teammate takeover
