...
- `docs/internal/comprehensive-progress.md` is directly reused by higher-layer narrative and material preparation, so this wording change should propagate to any derivative competition summary that still says `T06 optimizer/lr frontier`.
