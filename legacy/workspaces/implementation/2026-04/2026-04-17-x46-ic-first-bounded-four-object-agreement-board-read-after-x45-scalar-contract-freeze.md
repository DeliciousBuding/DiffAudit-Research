...
- `<DIFFAUDIT_ROOT>/Research/docs/internal/comprehensive-progress.md`: note-level sync recommended
- `<DIFFAUDIT_ROOT>/Research/docs/internal/mainline-narrative.md`: note-level sync recommended
