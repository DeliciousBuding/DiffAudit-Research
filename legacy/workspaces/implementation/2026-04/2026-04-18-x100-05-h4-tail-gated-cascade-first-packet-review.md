...
- `<DIFFAUDIT_ROOT>/Research/docs/internal/report-bundles/gpt54/round2-results/05.md`
...
- `Research/docs/internal/future-phase-e-intake.md`: update required
...
- `Research/docs/internal/leader-research-ready-summary.md`: update recommended
