...
- `Research/docs/internal/comprehensive-progress.md`: already synced
- `Research/docs/internal/mainline-narrative.md`: already synced
- `Research/docs/internal/future-phase-e-intake.md`: already synced
