...
One real active residue still existed in `docs/internal/mainline-narrative.md`, whose control-plane paragraph was still frozen at `X-76`. That residue is now cleared.
