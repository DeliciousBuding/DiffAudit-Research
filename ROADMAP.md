...
| CPU sidecar | none selected after ReDiffuse STL-10 denoising-loss and score-norm weak results. The released scout completed `300` steps and produced a `256 / 256` score packet, but fixed-timestep denoising-loss was random-level (`AUC = 0.4996337890625`, `ASR = 0.509765625`, `TPR@1%FPR = 0.01171875`, `TPR@0.1%FPR = 0.0`); a one-pass SimA-style denoiser-output score-norm scorer on the same checkpoint/split was also random-level (`AUC = 0.5052947998046875`, `ASR = 0.525390625`, `TPR@1%FPR = 0.03125`, `TPR@0.1%FPR = 0.01953125`). |
