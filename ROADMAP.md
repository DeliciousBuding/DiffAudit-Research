...
alternate attention layer transfers on the tiny target pair, but it ties the
raw-gradient L2 baseline and lacks held-out shadow stability. See
...
3. The current active CPU task is the white-box influence/curvature stability
   ...
   `up_blocks.1.attentions.0.to_v`; if it does not beat raw-gradient L2 under
...
| GSA diagonal-Fisher layer scope | mixed-but-not-gpu-ready; one layer transfers on a tiny pair but ties raw-gradient L2 | [docs/evidence/gsa-diagonal-fisher-layer-scope-review-20260511.md](docs/evidence/gsa-diagonal-fisher-layer-scope-review-20260511.md) |
