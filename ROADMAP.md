...
| Sidecar | Mode | Why |
| --- | --- | --- |
| black-box response-contract acquisition audit | CPU-only | Check whether local `Download/` assets contain a second compatible response-strength or simple-distance contract. |
