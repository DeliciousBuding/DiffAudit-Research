...
- `main.tex`、`refs.bib` 和 `paper.pdf`：IEEEtran 会议格式稿件已通过
  `pdflatex + bibtex + pdflatex + pdflatex` 手动链路编译，当前为 `7` 页 draft。
  ...
  Artifact Corpus、fixed-search batch summary、Admitted Bundle、H2 case study、
  H2 admission-decision table、Negative/Support Evidence、decision-value table、
  Threats to Validity 和 Discussion/Conclusion。
...
1. 继续把 Direction A 的 `7` 页稿件打磨成可投稿论文：压实 motivation、
