...
| Field | Current value |
| --- | --- |
| Active work | `FCRE medical frequency artifact gate completed after Tabular Privacy Leakage TDM; paper reports frequency-calibrated reconstruction-error MIA metrics, but no official code, immutable splits, target checkpoints, generated reconstructions, score rows, ROC arrays, metric JSON, or verifier output is public.` |
