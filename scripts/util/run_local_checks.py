...
def main(argv: list[str] | None = None) -> None:
    ...
    run([python_executable, "scripts/util/bootstrap_research_env.py"], repo_root)
    ...
    run([python_executable, "scripts/paper/export_admitted_evidence_bundle.py", "--check"], repo_root)
