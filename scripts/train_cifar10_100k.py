"""CIFAR-10 DDPM 100k-step training — paper-scale checkpoint.
10k was insufficient (AUC=0.503); 100k should produce detectable MIA signal.
"""
...
OUTPUT_DIR = os.environ.get('DIFFAUDIT_OUTPUT', os.path.join(_RESEARCH, 'outputs', 'cifar10-100k'))
