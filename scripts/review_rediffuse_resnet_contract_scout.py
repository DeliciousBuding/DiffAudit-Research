    ...
    adapter_features = {
        ...
        "stores_best_checkpoint_by_test_acc": (
            (
                ...
                or _snippet_present(current_adapter, 'checkpoint_policy == "best_heldout" and test_acc > selected_acc')
            )
            and (
                _snippet_present(current_adapter, "best_acc = test_acc")
                or _snippet_present(current_adapter, "selected_acc = test_acc")
            )
        ),
