...
PAPER_RELATIVE_INPUTS = [
    ("blinded_row_packet", "data/false_promotion_blinded_review_packet.csv"),
    ("blank_template", "data/false_promotion_external_review_template.csv"),
    ("adjudication_key", "data/false_promotion_adjudication_key.csv"),
    ("author_keyed_row_packet", "data/false_promotion_external_review_packet.csv"),
    ("row_trace", "data/false_promotion_row_trace.csv"),
    ("rule_summary", "data/false_promotion_rule_summary.csv"),
    ("author_gate_matrix", "data/false_promotion_author_gate_matrix.csv"),
    ("author_gate_summary", "data/false_promotion_gate_summary.csv"),
    ("source_rows", "data/false_promotion_exemplars.csv"),
