...
- 材料索引路径：`references/materials/black-box/2025-ndss-black-box-membership-inference-fine-tuned-diffusion-models.pdf`
...
- 材料索引路径：`references/materials/gray-box/2024-iclr-pia-proximal-initialization.pdf`
...
- 材料索引路径：`references/materials/gray-box/2026-crad-temporal-membership-inference-attack-method-diffusion-models.pdf`
...
- 开源仓库：暂未找到
- 阅读报告：[本地阅读报告：Temporal Membership Inference Attack Method for Diffusion Models](../../docs/internal/paper-reports/gray-box/2026-crad-temporal-membership-inference-attack-method-diffusion-models-report.md)
...
- 材料索引路径：`references/materials/gray-box/2025-arxiv-small-noise-injection-membership-inference-diffusion-models.pdf`
...
- 材料索引路径：`references/materials/white-box/2024-neurips-finding-nemo-localizing-memorization-neurons-diffusion-models.pdf`
...
- 材料索引路径：`references/materials/white-box/2025-local-mirror-white-box-membership-inference-diffusion-models.pdf`
...
- 材料索引路径：`references/materials/context/diffaudit-product-requirements.pdf`
...
- 材料索引路径：`references/materials/context/diffaudit-team-onboarding.pdf`
...
- 材料索引路径：`references/materials/survey/2025-neurips-tracing-the-roots-origin-attribution-diffusion-trajectories.pdf`
...
- 材料索引路径：`references/materials/survey/2025-icdar-dp-docldm-private-document-image-generation-latent-diffusion.pdf`
...
- 材料索引路径：`references/materials/survey/2024-arxiv-dual-model-defense-diffusion-membership-inference-disjoint-data-splitting.pdf`
...
- 材料索引路径：`references/materials/survey/2025-ndss-diffence-fencing-membership-privacy-diffusion-models.pdf`
...
- 材料索引路径：`references/materials/survey/2025-arxiv-defending-diffusion-models-membership-inference-higher-order-langevin-dynamics.pdf`
...
- 材料索引路径：`references/materials/survey/2026-arxiv-inference-attacks-graph-generative-diffusion-models.pdf`
...
- 材料索引路径：`references/materials/survey/2025-arxiv-perturb-a-model-not-an-image-anti-personalized-diffusion-models.pdf`
...
- 材料索引路径：`references/materials/survey/survey-index-diffusion-privacy-literature.pdf`
