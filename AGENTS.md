...
- Active work: `ReDiffuse raw transfer provenance recheck completed after the FMIA OpenReview bounded recheck. Research PR #261 records the two original collaborator chat attachments for the Stable Diffusion ReDiffuse bundle: the full transfer ZIP is 512403674 bytes with SHA-256 3b2f6ea09ce7d9ece4957ec635bac322e0b545b833f1d902f46abbf44f6fef73, 2558 entries, and 542464818 uncompressed bytes; artifacts.zip is 349479 bytes with SHA-256 1cb085e1df5c6f305f8af5562be51bf7af7277fd2fa8467c5ce401ed56aff447, 6 entries, and 1566286 uncompressed bytes. artifacts.zip is only the final metrics/result/ROC subset already represented under runs/final_rediffuse_combined. Current-state probes still return ready for probe-rediffuse-sd-artifacts and probe-rediffuse-sd-assets on the imported local subset. The existing 5000-row 2500/2500 packet still recomputes to AUC = 0.710319, ASR = 0.6846, TPR@1%FPR = 0.0736, and TPR@0.1%FPR = 0.0100. Decision: raw transfer provenance closed / candidate-only unchanged / no new download / no GPU release / no admitted Platform or Runtime row. active_gpu_question = none; next_gpu_candidate = none; CPU sidecar = none selected after ReDiffuse raw transfer provenance recheck.`
