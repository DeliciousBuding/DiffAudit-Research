...
| [`direction-b-output-cloud-short-paper.md`](direction-b-output-cloud-short-paper.md) | Response Geometry Team | Mechanism short/workshop paper | Strong case-study track, no full-paper portability claim yet. |
| [`direction-c-artifact-reproducibility-paper.md`](direction-c-artifact-reproducibility-paper.md) | Artifact Reproducibility Team | Claim-support reproducibility/measurement paper | Promote after metadata-only corpus expansion. |
| [`direction-d-audit-systems-paper.md`](direction-d-audit-systems-paper.md) | Audit Systems Team | Systems/artifact/demo paper | Hold until deployment or external-use evidence exists. |
