...
SD/CelebA img2img contract. Finally, bounded scouts and a frozen metadata-only
search batch over GitHub and arXiv show why second-asset claims require artifact contracts rather
than metric prose: 17 fixed-search rows add selection-process evidence but no
new admitted audit row. DiffAudit is therefore a measurement framework: it
...
reproducibility-prevalence claim.}
...
standalone artifact-reproducibility paper would still need a larger frozen
