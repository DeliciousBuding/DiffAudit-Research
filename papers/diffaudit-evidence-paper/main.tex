...
argument; a standalone artifact-reproducibility paper would need a larger frozen
corpus and gate-label consistency review before making aggregate claims.
...
larger frozen corpus protocol and gate-label consistency review before drawing
broader conclusions about public artifact availability. The 2026-05-26
fixed-search batch reduces project-history bias, but it remains a small
metadata-only process trace rather than a prevalence estimate.
