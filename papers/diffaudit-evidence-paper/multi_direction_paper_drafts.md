...
| C | Artifact Reproducibility Team | Claim-support reproducibility/measurement paper | v1 metadata corpus, fixed-search batch, and gate-summary assets now exist; needs gate-label consistency before standalone aggregate claims. |
...
| Artifact Reproducibility Team | What claims do public diffusion MIA artifacts actually support? | Use v1, the 2026-05-26 fixed-search batch, and generated gate-summary counts for claim-control drafting; next add consistency review. | Stop if aggregate claims exceed the selected corpus. |
...
2. Use Direction C v1 plus the fixed-search metadata batch and gate-summary
   assets for selected-corpus claim-control drafting, then run gate-label
   consistency review.
