...
def get_intermediate_results(model, FLAGS, data_loader, t_sec, timestep, device='cuda'):
...
def secmi_attack(
    ...
    member_results = get_intermediate_results(model, FLAGS, member_loader, t_sec, timestep, device=device)
    nonmember_results = get_intermediate_results(model, FLAGS, nonmember_loader, t_sec, timestep, device=device)
