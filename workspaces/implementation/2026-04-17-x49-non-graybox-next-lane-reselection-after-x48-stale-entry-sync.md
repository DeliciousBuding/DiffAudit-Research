...
- `<DIFFAUDIT_ROOT>/Research/docs/comprehensive-progress.md`: optional note-level sync
- `<DIFFAUDIT_ROOT>/Research/docs/mainline-narrative.md`: optional note-level sync
