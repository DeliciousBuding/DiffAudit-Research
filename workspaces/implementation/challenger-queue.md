...
| Field | Value |
| --- | --- |
| Active work | `DME dual-model entropy artifact gate completed after FreMIA frequency-filter artifact gate` |
| Active GPU task | none running |
| Next GPU candidate | none selected |
| CPU sidecar | none selected after DME dual-model entropy artifact gate |
