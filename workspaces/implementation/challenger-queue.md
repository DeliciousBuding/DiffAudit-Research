...
| Field | Value |
| --- | --- |
| Active work | `hyperparameter-free SecMI reproduction gate completed after DME and FreMIA gates` |
| Active GPU task | none running |
| Next GPU candidate | none selected |
| CPU sidecar | none selected after hyperparameter-free SecMI reproduction gate |
