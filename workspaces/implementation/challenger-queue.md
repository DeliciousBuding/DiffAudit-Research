...
| Field | Value |
| --- | --- |
| Active work | `FreMIA frequency-filter artifact gate completed after CopyMark official score artifact gate` |
| Active GPU task | none running |
| Next GPU candidate | none selected |
| CPU sidecar | none selected after FreMIA frequency-filter artifact gate |
