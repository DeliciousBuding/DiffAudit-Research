...
conda run -n diffaudit-research python -m diffaudit run-dpdm-w1-shadow-comparator `
  --workspace D:\Code\DiffAudit\Project\workspaces\white-box\runs\dpdm-w1-shadow-comparator-20260408 `
  --target-checkpoint-path D:\Code\DiffAudit\Project\external\DPDM\runs\dpdm-cifar10-32-eps10-gpu-smoke-v7\checkpoints\final_checkpoint.pth `
  --shadow-checkpoint-path D:\Code\DiffAudit\Project\external\DPDM\runs\dpdm-cifar10-shadow01-eps10-gpu-smoke-v1\checkpoints\final_checkpoint.pth `
  --target-member-dataset-dir D:\Code\DiffAudit\Project\workspaces\white-box\assets\gsa-cifar10-1k-3shadow\datasets\target-member `
  --target-nonmember-dataset-dir D:\Code\DiffAudit\Project\workspaces\white-box\assets\gsa-cifar10-1k-3shadow\datasets\target-nonmember `
  --shadow-member-dataset-dir D:\Code\DiffAudit\Project\workspaces\white-box\assets\gsa-cifar10-1k-3shadow\datasets\shadow-01-member `
  --shadow-nonmember-dataset-dir D:\Code\DiffAudit\Project\workspaces\white-box\assets\gsa-cifar10-1k-3shadow\datasets\shadow-01-nonmember `
  --dpdm-root D:\Code\DiffAudit\Project\external\DPDM `
  --config-path D:\Code\DiffAudit\Project\external\DPDM\configs\cifar10_32\train_eps_10.0.yaml `
  --device cuda `
  --sigma-points 4 `
  --max-samples 64
```
