...
conda run -n diffaudit-research python -m diffaudit run-dpdm-w1-target-only `
  --workspace D:\Code\DiffAudit\Project\workspaces\white-box\runs\dpdm-w1-target-only-20260408 `
  --checkpoint-path D:\Code\DiffAudit\Project\external\DPDM\runs\dpdm-cifar10-32-eps10-gpu-smoke-v7\checkpoints\final_checkpoint.pth `
  --member-dataset-dir D:\Code\DiffAudit\Project\workspaces\white-box\assets\gsa-cifar10-1k-3shadow\datasets\target-member `
  --nonmember-dataset-dir D:\Code\DiffAudit\Project\workspaces\white-box\assets\gsa-cifar10-1k-3shadow\datasets\target-nonmember `
