...
- `CLiD`: next selected bounded lane; local bridge preparation succeeded, and
  ...
  into artifact summarization; tiny score-bridge execution is the next CPU step.
...
Run the prepared CLiD bridge through a tiny score summary before any GPU packet.
...
prompt-conditioned black-box lane, with bridge and score schema gates wired.
