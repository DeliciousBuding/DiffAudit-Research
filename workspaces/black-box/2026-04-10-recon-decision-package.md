...
conda run -n diffaudit-research python -m diffaudit run-recon-artifact-mainline `
  --artifact-dir D:\Code\DiffAudit\Project\experiments\recon-runtime-mainline-ddim-public-100-step30\score-artifacts `
  --workspace D:\Code\DiffAudit\Project\experiments\recon-artifact-mainline-public-100-step30-reverify-20260410-round28 `
  --repo-root D:\Code\DiffAudit\Project\external\Reconstruction-based-Attack
```
