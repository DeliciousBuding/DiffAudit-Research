...
12. 当前 `TMIA-DM` 已完成最小 `protocol probe`、一次 repeat、same-split 比较、late-window refine，以及两次正向 `GPU128` rung；结论是该线已进入 repeat-confirmed GPU challenger 状态，但仍未足够替代 `PIA` 主线
