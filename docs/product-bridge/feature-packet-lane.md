...
> 状态：候选合约 / 未准入（2026-05-25 修订） | 当前正面候选：Tracing the Roots
...
灰盒 feature-packet 候选消费者线路用于定义未来的 Platform/Runtime 消费边界。
截至 2026-05-25，它还不是已准入消费通道。
...
Tracing the Roots 或其他 feature-packet 证据若要进入 Platform/Runtime，至少需要：
