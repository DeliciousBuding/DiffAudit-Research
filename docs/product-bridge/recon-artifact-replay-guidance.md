...
- replay 目录内的 artefact 没有经过跨团队审查、比赛导师确认或主线 narrative 的最终 gating。它们没有被纳入 `Docs/internal/competition-evidence-pack.md` (internal — not in public repository) 里的 admitted 视觉证明，也没有被列入任何 mainline narrative claim，因此不能作为比赛主讲或对外证明的 evidence。
