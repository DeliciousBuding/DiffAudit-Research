...
提供，并由 `scripts/render_admitted_risk_card.py --check` 从准入捆绑包生成和校验；它只展示五个准入角色、replay/source tier、finite-tail caveat 和候选排除规则。
...
[../evidence/feature-packet-channel-consumer-verdict-20260525.md](../evidence/feature-packet-channel-consumer-verdict-20260525.md)、
...
[../evidence/h2-output-cloud-geometry-20260525.md](../evidence/h2-output-cloud-geometry-20260525.md)。
