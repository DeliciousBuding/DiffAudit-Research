...
| White-box `GSA` | `evidence-ready` | Strongest white-box method. Upper-bound reference. The GSA loss-score Gaussian LR scorer did not pass leave-one-shadow-out stability and remains negative-but-useful diagnostic evidence, not a distinct promoted scorer. The influence/curvature line now has a CPU-only selected-layer micro-board and layer-scope review; it remains not GPU-ready because the only transferring layer ties raw-gradient L2 and lacks stability. See [gsa-loss-score-shadow-stability-review.md](gsa-loss-score-shadow-stability-review.md), [whitebox-influence-curvature-feasibility-scout-20260511.md](whitebox-influence-curvature-feasibility-scout-20260511.md), [gsa-diagonal-fisher-feasibility-microboard-20260511.md](gsa-diagonal-fisher-feasibility-microboard-20260511.md), and [gsa-diagonal-fisher-layer-scope-review-20260511.md](gsa-diagonal-fisher-layer-scope-review-20260511.md). |
