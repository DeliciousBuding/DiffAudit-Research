...
| Black-box `CLiD` | `next-lane-selected` | Selected as the next bounded black-box lane after H2 SD/CelebA text-to-image transfer was protocol-blocked. Start with local bridge and artifact-schema validation. See [black-box-next-lane-selection.md](black-box-next-lane-selection.md). |
