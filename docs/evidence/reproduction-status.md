...
| Black-box `CLiD` | `positive-bounded-candidate` | Selected as the next bounded black-box lane after H2 SD/CelebA text-to-image transfer was protocol-blocked. The 8/8 tiny score bridge was reusable but not promotable; the 100/100 packet clears the score-summary gate with strong low-FPR signal and survives the first integrity review. This is candidate-only until an independent repeat or perturbation passes. See [black-box-next-lane-selection.md](black-box-next-lane-selection.md), [clid-bridge-contract.md](clid-bridge-contract.md), [clid-score-schema-gate.md](clid-score-schema-gate.md), [clid-tiny-score-bridge.md](clid-tiny-score-bridge.md), [clid-100-score-packet.md](clid-100-score-packet.md), and [clid-candidate-integrity-review.md](clid-candidate-integrity-review.md). |
