...
| Black-box second response-contract | `needs-assets` | The package contract is defined, but the current `Download/black-box` roots contain no paired dataset/supplementary package with member/nonmember queries, endpoint contract, response manifest, and responses. See [blackbox-response-contract-asset-acquisition-spec.md](blackbox-response-contract-asset-acquisition-spec.md), [blackbox-response-contract-discovery.md](blackbox-response-contract-discovery.md), and [blackbox-response-contract-second-asset-intake-20260511.md](blackbox-response-contract-second-asset-intake-20260511.md). |
