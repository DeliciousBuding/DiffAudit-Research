...
| White-box `GSA` | `evidence-ready` | Strongest white-box method. Upper-bound reference. The GSA loss-score Gaussian LR scorer did not pass leave-one-shadow-out stability and remains negative-but-useful diagnostic evidence, not a distinct promoted scorer. The influence/curvature feasibility line now has a CPU-only selected-layer diagonal-Fisher micro-board; extraction is viable, but the score is negative-but-useful and releases no GPU. See [gsa-loss-score-shadow-stability-review.md](gsa-loss-score-shadow-stability-review.md), [whitebox-influence-curvature-feasibility-scout-20260511.md](whitebox-influence-curvature-feasibility-scout-20260511.md), and [gsa-diagonal-fisher-feasibility-microboard-20260511.md](gsa-diagonal-fisher-feasibility-microboard-20260511.md). |
