...
| Black-box `CLiD` | `tiny-score-bridge-ready` | Selected as the next bounded black-box lane after H2 SD/CelebA text-to-image transfer was protocol-blocked. Local bridge artifact contract is reusable, score-summary schema gate is defined, and the first 8/8 tiny score bridge is reusable but not promotable because it fails the minimum sample gate. See [black-box-next-lane-selection.md](black-box-next-lane-selection.md), [clid-bridge-contract.md](clid-bridge-contract.md), [clid-score-schema-gate.md](clid-score-schema-gate.md), and [clid-tiny-score-bridge.md](clid-tiny-score-bridge.md). |
