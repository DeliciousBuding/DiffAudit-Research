...
| [github-lightweight-diffusion-mia-triage-20260515.md](github-lightweight-diffusion-mia-triage-20260515.md) | Compact GitHub false-positive triage for lightweight/course-style direct diffusion-MIA repositories with no target/split/response/score/ROC/metric/verifier artifacts, download, GPU release, or admitted row. |
...
| [identity-focused-inference-extraction-artifact-gate-20260523.md](identity-focused-inference-extraction-artifact-gate-20260523.md) | Identity-Focused Inference / Extraction gate; arXiv `2410.10177` is paper-source-only identity-level privacy evidence with no official code, checkpoint-bound identity/row/score/ROC/metric/verifier artifacts, no download, no GPU release, and no admitted row. |
| [rapta-admcd-copying-mitigation-artifact-gate-20260523.md](rapta-admcd-copying-mitigation-artifact-gate-20260523.md) | RAPTA / ADMCD copying and memorization mitigation gate; arXiv `2603.13070` is paper-source-only with no official code, checkpoint-bound row/score/ROC/metric/verifier artifacts, no download, no GPU release, and no admitted row. |
| [guard-surgical-mitigation-artifact-gate-20260523.md](guard-surgical-mitigation-artifact-gate-20260523.md) | GUARD surgical memorization-mitigation gate; official `kairanzhao/GUARD` code is public, but no checkpoint-bound row/score/ROC/metric/verifier artifacts are released, so no download, no GPU release, and no admitted row. |
| [baf-lora-parameter-space-mitigation-gate-20260523.md](baf-lora-parameter-space-mitigation-gate-20260523.md) | BAF LoRA parameter-space mitigation gate; arXiv `2605.10439` is a weight-only LoRA memorization-mitigation watch item with supplementary-code claim only, no public score/ROC/metric artifacts, no download, no GPU release, and no admitted row. |
