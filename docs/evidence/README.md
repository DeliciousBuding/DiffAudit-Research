...
| [ib-defended-shadow-training-manifest-20260512.md](ib-defended-shadow-training-manifest-20260512.md) | CPU-only manifest proving the future I-B defended-shadow training set is specified before any GPU run. |
