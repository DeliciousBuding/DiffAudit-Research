...
| [midfreq-residual-scorer-contract-20260512.md](midfreq-residual-scorer-contract-20260512.md) | CPU scorer contract for band-pass same-noise residual scoring; collector remains pending. |
| [midfreq-residual-collector-contract-20260512.md](midfreq-residual-collector-contract-20260512.md) | CPU-compatible collector function contract for matched `x_t` / `tilde_x_t` residual states; executable runner remains pending. |
