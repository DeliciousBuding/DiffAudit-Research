...
| --- | --- | --- | --- |
| SIMA | `sima-cifar10-runtime-rescan-20260416-cpu-32-r2`, `sima-packet-score-export-pia-full-overlap-20260421-r1`, `cross-box-pairboard-pia-sima-full-overlap-20260421-r1` | Standalone CPU scan is weak (`AUC = 0.584961`, `TPR@0.1%FPR = 0.03125`). PIA+SIMA pairboard improves AUC in repeated holdout, but strict-tail wins are unstable. | Hold. Do not run a larger SIMA or SIMA+PIA packet without a new low-FPR-primary scorer contract. |
