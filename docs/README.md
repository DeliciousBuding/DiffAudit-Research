...
| 6 | [start-here/paper1-corrected-evidence-runbook-2026-07-11.md](start-here/paper1-corrected-evidence-runbook-2026-07-11.md) | Current Paper 1 member-only matched-target protocol. |
...
| `legacy/` | Historical experiment logs if present in a local archival checkout. |
...
- **Public documents must not link to parent-relative internal or ask-gpt paths.**
