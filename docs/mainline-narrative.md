...
1. 将 [2026-04-09-pia-provenance-dossier](../workspaces/gray-box/2026-04-09-pia-provenance-dossier.md) 固定为 `remain long-term blocker`，并明确它不计入当前 release queue
2. 不再为 `PIA 8GB portability ladder / defense-cost frontier` 预留新的 GPU 槽位；`G1-B` 继续保持 `no-go / not-requestable`
