...
1. 用 [2026-04-09-pia-provenance-dossier](../workspaces/gray-box/2026-04-09-pia-provenance-dossier.md) 收口 `PIA provenance`
2. 用 [2026-04-10-recon-explanation-layer](../workspaces/black-box/2026-04-10-recon-explanation-layer.md) 吸收 `CopyMark` 现实边界与频域解释层
3. 用 [future-phase-e-intake](future-phase-e-intake.md) 固定 `Phase E` 候选池排序并只做准入验证
4. 在 `PIA provenance` 闭环前，不放行新的主 GPU 问题
