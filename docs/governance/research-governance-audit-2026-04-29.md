...
| Size | Path family |
| ---: | --- |
| `729.50 KB` | `docs/internal/paper-reports/assets/white-box/...png` |
| `684.50 KB` | `docs/internal/paper-reports/assets/black-box/...png` |
| `564.20 KB` | `docs/internal/paper-reports/assets/black-box/...jpeg/png` |
| `502.30 KB` | `docs/internal/paper-reports/assets/gray-box/...png` |
...
| `tools/gsa-next-run/minimal/assets-root/data.bin` | removed from current tree | Tiny binary fixture was not needed for the example contract; text fixture remains. |
