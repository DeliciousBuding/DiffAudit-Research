...
**Files:**
- Create: `docs/internal/paper-reports/README.md`
- Create: `docs/internal/paper-reports/report-spec.md`
- Create: `docs/internal/paper-reports/report-template.md`
...
**Files:**
- Create: `docs/internal/paper-reports/manifest.csv`
- Create: `docs/internal/paper-reports/black-box/.gitkeep`
- Create: `docs/internal/paper-reports/gray-box/.gitkeep`
- Create: `docs/internal/paper-reports/white-box/.gitkeep`
- Create: `docs/internal/paper-reports/survey/.gitkeep`
- Create: `docs/internal/paper-reports/context/.gitkeep`
- Create: `docs/internal/paper-reports/assets/.gitkeep`
...
**Files:**
- Modify: `docs/internal/paper-reports/manifest.csv`
- Create: `docs/internal/paper-reports/<track>/<report>.md`
