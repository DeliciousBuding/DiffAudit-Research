...
- 任何 replay/artifact（如 recon replay/demo traces、`Research/experiments/*` 中的复查脚本）只能在 Runtime 里标记为 “debug/replay/comparator trace”，不得用来支撑 admitted claim。
...
- 需要 Developer/Leader 复查 `Research/workspaces/implementation/artifacts/unified-attack-defense-table.json`、`Research/docs/internal/competition-evidence-pack.md`、`Research/docs/evidence/research-boundary-card.md`，确认 metrics/boundary 字段能无缝对接平台展示与答辩口径。
