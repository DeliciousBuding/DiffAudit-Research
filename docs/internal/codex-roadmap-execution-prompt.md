...
- `X-180` 已关闭为 `positive reselection / GPU hold`：当前没有 immediate GPU candidate；治理完成后的下一条 CPU-first lane 是 `X-181 I-A / cross-box boundary maintenance after H2 comparator block`
