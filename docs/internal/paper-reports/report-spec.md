...
- 上游来源 URL
- 本地材料获取方式
  说明：材料原件属于外部资产层，不由 GitHub 仓库分发；如果
  没有独立公开 PDF 链接，至少写“见 manifest/source_url 或团队资产镜像”
- 开源实现
- 报告状态
...
- 图片必须满足：
  ...
  - 清晰度足够
- 最终图片文件名统一为：
  `docs/internal/paper-reports/assets/<track>/<pdf-stem>-key-figure-p<page>.png`
- 如果一篇报告有多张图，文件名依次使用：
