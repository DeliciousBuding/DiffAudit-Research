...
本稿只保留 1 张关键图，即结果曲线图 `docs/internal/paper-reports/assets/gray-box/2025-cvpr-cdi-copyrighted-data-identification-diffusion-models-key-figure-p6.png`。它应放在“主要结果”段落之后，用于说明不同模型达到显著性所需的嫌疑样本规模差异，以及为什么 CDI 更适合做集合级审计预算评估。
