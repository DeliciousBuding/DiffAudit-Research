...
| `docs/paper-reports/ocr/` | OCR cache output is generated and not source material. |
| `docs/paper-reports/markdown/` | Full-paper extraction caches should not be tracked. |
