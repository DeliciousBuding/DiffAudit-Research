...
- 上游来源 URL：见 `references/materials/manifest.csv` 中 `references/materials/gray-box/2026-openreview-mofit-caption-free-membership-inference.pdf` 对应的 `source_url` 字段
