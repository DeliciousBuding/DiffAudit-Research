...
- 上游来源 URL：见 `references/materials/manifest.csv` 中 `references/materials/gray-box/2026-crad-temporal-membership-inference-attack-method-diffusion-models.pdf` 对应的 `source_url` 字段
- OCR 精修版链接：待补
- 飞书原生 PDF 获取方式：待补
- 开源实现：暂未找到
- 报告状态：已完成
