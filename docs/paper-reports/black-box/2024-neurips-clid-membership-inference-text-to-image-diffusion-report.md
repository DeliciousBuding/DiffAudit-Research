...
- 上游来源 URL：见 `references/materials/manifest.csv` 中 `references/materials/black-box/2024-neurips-clid-membership-inference-text-to-image-diffusion.pdf` 对应的 `source_url` 字段
