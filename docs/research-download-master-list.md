...
- Current `Recon` asset stack is already present under `D:\Code\DiffAudit\Download\black-box\supplementary\recon-assets\`
- Current `CLiD` codebase is already present under `external/CLiD/`, while the raw supplementary mirror is under `D:\Code\DiffAudit\Download\black-box\supplementary\clid-mia-supplementary\`
